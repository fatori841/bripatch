<div class="pagetitle">
  <h1 align="center">CMS - Show Data User</h1>
</div>
<!-- End Page Title -->
...
<div class="card mb-3">
	...
	<div class="card-body">
	  ...
	  <form id="search_data_cc" class="row g-3 needs-validation" action="" method="post" novalidate>

		<div class="row mb-3">
		  <label for="client_handle" class="col-sm-2 col-form-label">Masukan ID Transaksi</label>
			<div class="col-sm-10">
...
$(document).ready(function(){
	$('#search_data_user').submit(function(){
		$.ajax({
			type : "POST",
			url  : "<?=site_url('Cms/search_data_trx_cc');?>",
			data : $(this).serialize(),
			beforeSend:function(){
				//$('#ajax-loader').show();
