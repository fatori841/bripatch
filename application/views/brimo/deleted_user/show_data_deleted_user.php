<div class="pagetitle">
  <h1 align="center">BRIMO - Deleted User Detail</h1>
</div>
<!-- End Page Title -->
	...
	<div class="card-body">
	  ...
	  <form id="search_data_user" class="row g-3 needs-validation" action="" method="post" novalidate>
		...
		<div class="row mb-3">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" name="value_txt" size="16" id="value_txt" required>
...
$(document).ready(function(){
	$('#search_data_user').submit(function(){
		$.ajax({
			type : "POST",
			url  : "<?=site_url('Brimo/search_data_deleted_user');?>",
			data : $(this).serialize(),
			beforeSend:function(){
				//$('#ajax-loader').show();
