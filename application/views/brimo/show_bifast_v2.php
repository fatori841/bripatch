<div class="pagetitle">
  <h1 align="center">BRIMO - Open Close BIFAST V2 All</h1>
</div>
<!-- End Page Title -->
...
$(document).ready(function(){
	$('#search_data_bifast').submit(function(){
		$.ajax({
			type : "POST",
			url  : "<?=site_url('Brimo/show_bifast_result_v2');?>",
			data : $(this).serialize(),
			beforeSend:function(){
				//$('#ajax-loader').show();
...
$(document).ready(function(){
	$('#close_bifast').submit(function(){
		$.ajax({
			type : "POST",
			url  : "<?=site_url('Brimo/close_bifast_all_v2');?>",
			data : $(this).serialize(),
			beforeSend:function(){
				//$('#ajax-loader').show();
...
$(document).ready(function(){
	$('#open_bifast').submit(function(){
		$.ajax({
			type : "POST",
			url  : "<?=site_url('Brimo/open_bifast_v2');?>",
			data : $(this).serialize(),
			beforeSend:function(){
				//$('#ajax-loader').show();
