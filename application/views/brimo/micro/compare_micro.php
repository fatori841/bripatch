<div class="pagetitle">
  <h1 align="center">BRIMO - Compare Microservices</h1>
</div>
<!-- End Page Title -->
	...
	<div class="card-body">
	  ...
	  <form id="search_form" class="row g-3 needs-validation" action="" method="post" novalidate>
		...
		<div class="row mb-3">
		  ...
		  <div class="col-sm-10">
			<input type="text" class="form-control" name="namespace_txt" id="namespace_txt" required readonly value="brimo">
...
$(document).ready(function(){
	$('#search_form').submit(function(){
		if(validate_form_micro() == true){
			$.ajax({
				type : "POST",
				url  : "<?=site_url('Brimo/capture_micro_compare_result');?>",
				data : $(this).serialize(),
				beforeSend:function(){
					//$('#ajax-loader').show();
