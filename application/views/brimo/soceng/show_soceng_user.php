<div class="pagetitle">
  <h1 align="center">BRIMO - Soceng User Detail</h1>
</div>
<!-- End Page Title -->
...
<div class="card mb-3">
	...
	<div class="card-body">
	  ...
	  <form id="search_data_user" class="row g-3 needs-validation" action="" method="post" novalidate>
		...
		<div class="row mb-3">
		  <label for="start_date" class="col-sm-2 col-form-label">Start Date (optional) </label>
		  <div class="col-sm-10">
...
$(document).ready(function(){
	$('#search_data_user').submit(function(){
		$.ajax({
			type : "POST",
			url  : "<?=site_url('Brimo/search_soceng_user');?>",
			data : $(this).serialize(),
			beforeSend:function(){
				//$('#ajax-loader').show();
